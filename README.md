...
| 🧭 **Fahrten & Ziele** | Für Umzüge mit wenigen, gezielten Fahrten (z.B. Haus nebenan): frei definierbare Ziele wie „Rüber nebenan“, „Fahrt nach München“, „Werkstoffhof / Spende“. Jeder Gegenstand bekommt ein Ziel; pro Fahrt gibt es eine **Ladeliste** mit Packfortschritt. Status „Entsorgen“ landet automatisch auf der Werkstoffhof-Fahrt. |
| 🤝 **Gemeinsam entscheiden** | Speziell für Deko, Spielzeug & Co.: Zwei Personen (Namen anpassbar) geben pro Stück ihren Wunsch ab — *Hier im Haus / Nach München / Weg / Egal*. **Einigkeit wird sofort übernommen** (Status + Fahrt), Uneinigkeit landet gut sichtbar in der **Klärungsliste** zum Drüber-Reden. |
